...
class Webserver {
  ...
  async init() {
    ...
    // this.server.get('/sponsors', async (req, res) => {
    //   try {
    //     const sponsors = await this.github.getSponsors();
    //     res.json(200, sponsors);
    //   } catch (e) {
    //     console.log(e);
    //     res.send(500);
    //   }
    ...
    // this.server.get('/list', async (req, res) => {
    //   try {
    //     const list = await this.chains.history();
    //     res.json(200, list);
    //   } catch (e) {
    //     console.log(e);
    //     res.send(500);
